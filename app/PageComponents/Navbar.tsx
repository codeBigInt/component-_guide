...
const Navbar = () => {
    return (
        <nav className="flex justify-between items-center left-0 top-0 w-full border-b-1 px-5 md:px-20 fixed z-[999] bg-white bg-opacity-[0.3] backdrop-blur-[10px] py-6 ">
